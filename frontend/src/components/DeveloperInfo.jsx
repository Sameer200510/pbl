    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
        ...
        <button
          ...
          className="w-6 h-6 rounded-full flex items-center justify-center text-gray-300 bg-transparent opacity-90 hover:opacity-100 hover:bg-gray-100/50 transition-all duration-300"
        >
